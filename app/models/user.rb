...
#####################################################################################################################################################################
  ...
  has_many(:liked_photos, through: :likes, source: :own_photos)

  # User#commented_photos: returns rows from the photos table associated to this user through its comments
  has_many(:commented_photos, through: :comments, source: :own_photos)
  ...
  has_many(:discover, through:"accepted_sent_follow_requests", source: :liked_photos)
